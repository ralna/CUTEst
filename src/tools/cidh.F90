...
!   fortran 2003 version released in CUTEst, 29th December 2012
      ...
      SUBROUTINE CUTEST_cidh_r( status, n, X, iprob, lh1, H )
...
!   fortran 2003 version released in CUTEst, 29th December 2012
      ...
      SUBROUTINE CUTEST_cidh_threaded_r( status, n, X, iprob, lh1, H, thread )
      USE CUTEST_KINDS_precision
      USE CUTEST_precision
...
!   fortran 2003 version released in CUTEst, 24th November 2012
      ...
      SUBROUTINE CUTEST_cidh_threadsafe_r( data, work, status, n, X, iprob,    &
                                           lh1, H )
      USE CUTEST_KINDS_precision
      USE CUTEST_precision
...
!  end of subroutine CUTEST_cidh_threadsafe_r

      END SUBROUTINE CUTEST_cidh_threadsafe_r
