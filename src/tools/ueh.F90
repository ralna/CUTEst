! THIS VERSION: CUTEST 2.3 - 2024-10-15 AT 14:00 GMT.

#include "cutest_modules.h"
#include "cutest_routines.h"

!-*-*-*-*-*-*-  C U T E S T    U E H _ C   S U B R O U T I N E  -*-*-*-*-*-*-
...
!   modern fortran version released in CUTEst, 15th October 2024
      ...
      SUBROUTINE CUTEST_ueh_c_r( status, n, X,                                 &
...
!  ----------------------------------------------------------------------------
      ...
      CALL CUTEST_ueh_threadsafe_r( CUTEST_data_global,                        &
...
!  end of subroutine CUTEST_ueh_c_r

      END SUBROUTINE CUTEST_ueh_c_r
...
!   fortran 2003 version released in CUTEst, 21st August 2013
      ...
      SUBROUTINE CUTEST_Cint_ueh_r( status, n, X,                              &
                                    ne, lhe_ptr, HE_row_ptr, HE_val_ptr,       &
                                    lhe_row, HE_row, lhe_val, HE_val, byrows )
      USE CUTEST_KINDS_precision
      USE CUTEST_precision
...
!  ----------------------------------------------------------------------------
      ...
      byrows_fortran = byrows
      CALL CUTEST_ueh_r( status, n, X,                                         &
                         ne, lhe_ptr, HE_row_ptr, HE_val_ptr,                  &
                         lhe_row, HE_row, lhe_val, HE_val, byrows_fortran )

      RETURN

!  end of subroutine CUTEST_Cint_ueh_r

      END SUBROUTINE CUTEST_Cint_ueh_r
...
!   fortran 2003 version released in CUTEst, 28th December 2012
      ...
      SUBROUTINE CUTEST_ueh_r( status, n, X,                                   &
                               ne, lhe_ptr, HE_row_ptr, HE_val_ptr,            &
                               lhe_row, HE_row, lhe_val, HE_val, byrows )
      USE CUTEST_KINDS_precision
      USE CUTEST_precision
...
!  end of subroutine CUTEST_ueh_r
...
!   fortran 2003 version released in CUTEst, 28th December 2012
      ...
      SUBROUTINE CUTEST_ueh_threaded_r( status, n, X, ne, lhe_ptr, HE_row_ptr, &
...
!  end of subroutine CUTEST_ueh_threaded_r
...
!   fortran 2003 version released in CUTEst, 27th November 2012
      ...
      SUBROUTINE CUTEST_ueh_threadsafe_r( data, work, status, n, X, ne,        &
...
!  local variables
      ...
      INTEGER ( KIND = ip_ ) :: i, j, ifstat, igstat, ig, alloc_status
...
!  update elapsed CPU time if required
  ...
  990 CONTINUE
      IF ( work%record_times ) THEN
        ...
        work%time_ueh = work%time_ueh + time_out - time_in
      END IF
      RETURN

!  end of subroutine CUTEST_ueh_threadsafe_r

      END SUBROUTINE CUTEST_ueh_threadsafe_r
