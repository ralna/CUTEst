...
!   modern fortran version released in CUTEst, 20th October 2024
      ...
      SUBROUTINE CUTEST_udh_c_r( status, n, X, lh1, H )
...
!  The Hessian is stored as a 1D lh1 * n array by rows
!  -------------------------------------------------------------------

      CALL CUTEST_udh_threadsafe_r( CUTEST_data_global,                        &
...
!  end of subroutine CUTEST_udh_c_r

      END SUBROUTINE CUTEST_udh_c_r
...
!   fortran 2003 version released in CUTEst, 28th December 2012
      ...
      SUBROUTINE CUTEST_udh_r( status, n, X, lh1, H )
      USE CUTEST_KINDS_precision
      USE CUTEST_precision
...
!  end of subroutine CUTEST_udh_r
...
!   fortran 2003 version released in CUTEst, 28th December 2012
      ...
      SUBROUTINE CUTEST_udh_threaded_r( status, n, X, lh1, H, thread )
      USE CUTEST_KINDS_precision
      USE CUTEST_precision
...
!  end of subroutine CUTEST_udh_threaded_r
...
!   fortran 2003 version released in CUTEst, 23rd November 2012
      ...
      SUBROUTINE CUTEST_udh_threadsafe_r( data, work, status, n, X, lh1, H )
      USE CUTEST_KINDS_precision
      USE CUTEST_precision
...
!  end of subroutine CUTEST_udh_threadsafe_r

      END SUBROUTINE CUTEST_udh_threadsafe_r
