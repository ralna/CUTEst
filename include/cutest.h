/* THIS VERSION: CUTEST 2.7 - 2026-06-04 AT 15:30 GMT */
 ...
 *
 * Fortran 1-based indices for interactions with Matlab and Julia
 *
...
#define CUTEST_cishp          FUNDERSCORE(cutest_cishp)
...
#define CUTEST_load_routines   FUNDERSCORE(cutest_load_routines)
#define CUTEST_unload_routines FUNDERSCORE(cutest_unload_routines)
...
void CUTEST_unames( integer *status, const integer *n, char *pname,
                    char *vnames );
void CUTEST_ureport( integer *status, rp_ *calls, rp_ *time );
...
void CUTEST_creport( integer *status, rp_ *calls, rp_ *time );
...
void CUTEST_ufn( integer *status, const integer *n, const rp_ *x,
                 rp_ *f );
void CUTEST_ugr( integer *status, const integer *n, const rp_ *x,
                 rp_ *g );
void CUTEST_uofg( integer *status, const integer *n, const rp_ *x,
                 rp_ *f, rp_ *g, const logical *grad );
void CUTEST_udh( integer *status, const integer *n, const rp_ *x,
                 const integer *lh1, rp_ *h );
void CUTEST_ushp( integer *status, const integer *n, integer *nnzh,
                  const integer *lh, integer *irnh, integer *icnh );
void CUTEST_ush( integer *status, const integer *n, const rp_ *x,
                 integer *nnzh, const integer *lh, rp_ *h,
                 integer *irnh, integer *icnh );
void CUTEST_ueh( integer *status, const integer *n, const rp_ *x,
                 integer *ne, const integer *le, integer *iprnhi,
                 integer *iprhi, const integer *lirnhi, integer *irnhi,
                 const integer *lhi, rp_ *hi,
                 const logical *byrows );
void CUTEST_ugrdh( integer *status, const integer *n, const rp_ *x,
                   rp_ *g, const integer *lh1, rp_ *h);
void CUTEST_ugrsh( integer *status, const integer *n, const rp_ *x,
                   rp_ *g, integer *nnzh, integer *lh, 
                   rp_ *h, integer *irnh, integer *icnh );
void CUTEST_ugreh( integer *status, const integer *n, const rp_ *x,
                   rp_ *g, integer *ne, const integer *le,
                   integer *iprnhi, integer *iprhi, const integer *lirnhi,
                   integer *irnhi, const integer *lhi, rp_ *hi,
                   const logical *byrows );
void CUTEST_uhprod( integer *status, const integer *n, const logical *goth,
                    const rp_ *x, const rp_ *p, 
                    rp_ *r );
void CUTEST_ushprod( integer *status, const integer *n, const logical *goth,
                     const rp_ *x, const integer *nnzp,
                     const integer *indp, const rp_ *p,
                     integer *nnzr, integer *indr, rp_ *r );
void CUTEST_ubandh( integer *status, const integer *n, const rp_ *x,
                    const integer *nsemib, rp_ *bandh,
...
void CUTEST_cfn( integer *status,  const integer *n, const integer *m,
                 const rp_ *x, rp_ *f, rp_ *c );
void CUTEST_cconst( integer *status,  const integer *m, rp_ *c );
void CUTEST_cofg( integer *status, const integer *n, const rp_ *x,
                  rp_ *f, rp_ *g, const logical *grad );
void CUTEST_cofsg( integer *status, const integer *n, const rp_ *x,
                   rp_ *f, integer *nnzg, const integer *lg,
                   rp_ *sg, integer *ivsg, const logical *grad );
...
void CUTEST_ccifg( integer *status,  const integer *n, const integer *icon,
                   const rp_ *x, rp_ *ci, rp_ *gci,
                   const logical *grad );
void CUTEST_ccifsg( integer *status, const integer *n, const integer *con,
                    const rp_ *x, rp_ *ci, integer *nnzsgc,
                    const integer *lsgci, rp_ *sgci, integer *ivsgci,
                    const logical *grad );
...
void CUTEST_cdhj( integer *status, const integer *n, const integer *m,
                  const rp_ *x, const rp_ *y0,
                  const rp_ *y, const integer *lh1,
                  rp_ *h );
...
void CUTEST_cisgr( integer *status, const integer *n, const integer *iprob,
                   const rp_ *x, integer *nnzg, const integer *lg,
                   rp_ *sg, integer *ivsg );
void CUTEST_cisgrp( integer *status, const integer *n, const integer *iprob,
                    integer *nnzg, const integer *lg, integer *ivsg );
void CUTEST_cidh( integer *status, const integer *n, const rp_ *x,
                  const integer *iprob, const integer *lh1, 
                  rp_ *h );
void CUTEST_cish( integer *status, const integer *n, const rp_ *x,
                  const integer *iprob, integer *nnzh, const integer *lh,
                  rp_ *h, integer *irnh, integer *icnh );
void CUTEST_cishp( integer *status, const integer *n, 
                   const integer *iprob, integer *nnzh, const integer *lh,
                   integer *irnh, integer *icnh );
...
void CUTEST_chprod( integer *status, const integer *n, const integer *m,
                    const logical *goth, const rp_ *x,
                    const rp_ *y, rp_ *p, rp_ *q );
void CUTEST_cshprod( integer *status, const integer *n, const integer *m,
                     const logical *goth, const rp_ *x,
                     const rp_ *y, const integer *nnzp,
                     const integer *indp, const rp_ *p,
                     integer *nnzr, integer *indr, rp_ *r );
...
void CUTEST_cshcprod( integer *status, const integer *n, const integer *m,
                      const logical *goth, const rp_ *x,
                      const rp_ *y, integer *nnzp, integer *indp,
                      rp_ *p, integer *nnzr, integer *indr,
                      rp_ *r );
...
void CUTEST_cohprods( integer *status, const integer *n,
                       const logical *goth, const rp_ *x,
                       const rp_ *p, integer *nnzohp, 
                       const integer *lohp, rp_ *ohpval, 
                       integer *ohpind );
...
void CUTEST_load_routines( const char *libname );

/* Unload dynamic library and reset pointers */
void CUTEST_unload_routines( void );
...
#define CUTEST_cishp_s          FUNDERSCORE(cutest_cishp_s)
...
#define CUTEST_load_routines_s   FUNDERSCORE(cutest_load_routines_s)
#define CUTEST_unload_routines_s FUNDERSCORE(cutest_unload_routines_s)
...
void CUTEST_cish_s( integer *status, const integer *n, const real *x,
                    ...
                    const integer *lh, real *h, integer *irnh, 
                    integer *icnh );
void CUTEST_cishp_s( integer *status, const integer *n,
                     const integer *iprob, integer *nnzh, 
                     const integer *lh, integer *irnh, integer *icnh );
...
/* Load dynamic library and resolve CUTEst routine symbols */
void CUTEST_load_routines_s( const char *libname );

/* Unload dynamic library and reset pointers */
void CUTEST_unload_routines_s( void );
...
#define CUTEST_cishp_q      FUNDERSCORE(cutest_cishp_q)
...
#define CUTEST_load_routines_q   FUNDERSCORE(cutest_load_routines_q)
#define CUTEST_unload_routines_q FUNDERSCORE(cutest_unload_routines_q)
...
void CUTEST_cish_q( integer *status, const integer *n, const quadreal *x,
                    ...
                    const integer *lh, quadreal *h, 
                    integer *irnh, integer *icnh );
void CUTEST_cishp_q( integer *status, const integer *n,
                     const integer *iprob, integer *nnzh, 
                     const integer *lh, integer *irnh, integer *icnh );
...
/* Load dynamic library and resolve CUTEst routine symbols */
void CUTEST_load_routines_q( const char *libname );

/* Unload dynamic library and reset pointers */
void CUTEST_unload_routines_q( void );
